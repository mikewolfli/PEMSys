================================================================================
    MICROSOFT 基础类库： PEMSys 项目概述
===============================================================================

应用程序向导已为您创建了此 PEMSys 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 PEMSys 应用程序的每个文件的内容摘要。
...
res\Toolbar.bmp
    ...
    更新 PEMSys.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加
    工具栏按钮。
/////////////////////////////////////////////////////////////////////////////
...
PEMSysDoc.h、PEMSysDoc.cpp - 文档
    这些文件包含 CPEMSysDoc 类。  编辑这些文件
    以添加特殊的文档数据并实现文件的保存和加载
    （通过 CPEMSysDoc::Serialize）。
    此文档将具有下列字符串：
        文件扩展名：      let
        文件类型 ID：        PEMSys.Document
        主框架标题：  PEMSys
        文档类型名称：       PEMSys
        筛选器名称：         PEMSys Files (*.let)
        文件的新简称： PEMSys
        文件类型全称： PEMSys.Document
PEMSysView.h、PEMSysView.cpp - 文档视图
    这些文件包含 CPEMSysView 类。
    CPEMSysView 对象用于查看 CPEMSysDoc 对象。
res\PEMSysDoc.ico
    这是一个图标文件，用作 
    CPEMSysDoc 类 MDI 子窗口的图标。  此图标包含在主
    资源文件 PEMSys.rc 中。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 PEMSys.pch 的预编译头文件 (PCH)
